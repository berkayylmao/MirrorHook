...
//  erroneous assert in InvalidateDeviceObjects(). 2019-01-16: Misc: Disabled fog before drawing
//  UI's. Fixes issue #2288. 2018-11-30: Misc: Setting up io.BackendRendererName so it can be
//  displayed in the About Window. 2018-06-08: Misc: Extracted imgui_impl_dx9.cpp/.h away from the
//  old combined DX9+Win32 example. 2018-06-08: DirectX9: Use draw_data->DisplayPos and
...
//  exposed RenderDrawData() in the .h file so you can call it yourself. 2018-02-06: Misc: Removed
//  call to ImGui::Shutdown() which is not available from 1.60 WIP, user needs to call
