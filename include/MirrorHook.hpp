...
namespace MirrorHook {
  ...
  static inline bool Init(Framework framework, const wchar_t* const szWindowTitle) {
    return reinterpret_cast<bool(__stdcall*)(Framework, const wchar_t* const)>(GetProcAddress(
        GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::InitWithWindowTitle"))(framework, szWindowTitle);
  }
  static inline bool Init(Framework framework, HWND& hWnd) {
    return reinterpret_cast<bool(__stdcall*)(Framework, HWND&)>(GetProcAddress(
        GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::InitWithWindowHandle"))(framework, hWnd);
  }
  static inline bool Init(Framework framework, void** ppDevice) {
    return reinterpret_cast<bool(__stdcall*)(Framework, void**)>(GetProcAddress(
        GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::InitWithDevicePointer"))(framework, ppDevice);
  }
  ...
  namespace D3D9 {
    ...
    static inline bool AddExtension(Type type, void* const pExtension) {
      return reinterpret_cast<bool(__stdcall*)(Type, void* const)>(
          GetProcAddress(GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::D3D9Extender::AddExtension"))(
          type, pExtension);
    }
  }  // namespace D3D9
  namespace D3D11 {
    ...
    static inline bool AddExtension(Type type, void* const pExtension) {
      return reinterpret_cast<bool(__stdcall*)(Type, void* const)>(
          GetProcAddress(GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::D3D11Extender::AddExtension"))(
          type, pExtension);
    }
  }  // namespace D3D11
  namespace WndProc {
    ...
    static inline bool AddExtension(void* const pExtension) {
      return reinterpret_cast<bool(__stdcall*)(void* const)>(GetProcAddress(
          GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::WndProcExtender::AddExtension"))(pExtension);
    }
    static inline HWND GetWindowHandle() {
      return reinterpret_cast<HWND(__stdcall*)()>(GetProcAddress(
          GetModuleHandle(TEXT("MirrorHook.dll")), "MirrorHookInternals::WndProcExtender::GetWindowHandle"))();
    }
  }  // namespace WndProc
}  // namespace MirrorHook
#endif
